...
VALUES
	...
	('rule', 'referring to yourself on in the third person', 'referring to yourself in the second person', 0, CURRENT_TIMESTAMP, TRUE, NULL),
	...
	('rule', 'in your best Shakespearian english', 'using all the cotemporary slang you can', 0, CURRENT_TIMESTAMP, TRUE, NULL),
